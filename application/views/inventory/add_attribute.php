        ...
        <div class="widget-content nopadding">
          <form action="#" method="post" class="form-horizontal">
              ...
              <div class="span6">
            	<div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <option value="0" <?php echo ($this_element->parent ==0) ? 'selected' : '';?>>None</option>
                    <?php foreach($allpr as $k){ ?>
                    <option value="<?php echo $k->id; ?>" <?php echo ($this_element->parent ==$k->id) ? 'selected' : '';?> ><?php echo $k->name; ?></option>
    				<?php } ?>
                    </select>
                  </div>
                </div>  
            ...
            <div class="form-actions">
              ...
              <a href="<?php echo base_url();?>inventory/attribute/"><button type="button" class="btn btn-sm btn-info">Back</button></a>
            </div>
          </form>
