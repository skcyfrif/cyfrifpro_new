                	...
                	<div class="tab-pane active" role="tabpanel" id="other_det">
                    	<div class="control-group">
                          ...
                          <div class="controls opc">
                           		<select name="currency" id="currency" onchange="addcurrency(this.value);" required>
            			...
            			<div class="control-group">
                          ...
                          <div class="controls opc">
                            <input type="text" class="span11" name="o_balnce" id="o_balnce" value="<?php echo $this_element->opening_balance; ?>" autocomplete="off" required/>
                          </div>
                        </div>
                    	...
                    	<div class="control-group">
                          ...
                          <div class="controls opc">
                           		<select name="pterms" id="pterms" required>
                                	<option value="">Select....</option>
