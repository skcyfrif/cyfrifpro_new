...
<div class="container-fluid">
    <div class="row-fluid"> 
        <div class="span12">
            <a href="<?php echo base_url(); ?>Clientstore/add_currency" ><button class="btn btn-success btn-sm pull-right">+ Add</button></a>
                            ...
                            if ($currency) {
                                ...
                                foreach ($currency as $kyx => $key) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="td-actions">
                                            <a href="<?php echo base_url(); ?>Clientstore/add_currency/<?php echo $key->id; ?>" class="btn btn-xs btn-info">
                                                Edit                                       
                                            </a>
