        ...
        <div class="container">
            <div class="row" style="margin-top: 50px;margin-bottom: 50px;">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus">
                    <h2 class="aboutus-title">SHARE TRADING</h2>
                    <div class="top-head-text">
                        <p>The success of our valued customer is our real success. You can achieve desired profit by the help of our research expert team, they can help you to take right decision at the right time. Cyfrifpro support service team always happy to assist you on end to end basis (24 x 7).  </p>
