        ...
        <div class="container">
            <div class="row" style="margin-top: 50px;margin-bottom: 50px;">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus">
                    <h2 class="aboutus-title">RECTIFY ERROR AND IMPROVE CREDIT SCORE</h2>
                    <div class="top-head-text">

<p>We @ Cyfrifpro rectifies credit score of our valued customers by rectifying Inaccurate Current Balance or Amount Overdue, Incorrect Personal Details, Incorrect Ownership with following up credit scoring organisations.</p>
