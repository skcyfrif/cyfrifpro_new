...
<img src="http://www.cyfrif.com/assets/site/images/debt.jpg" alt="banner">
    ...
    <div class="banner-caption">
    	<div class="wrapper">
        	<div class="banner-box">
                 <h2>CREDIT REPAIR <br><span>AND DEBT MANAGEMENT SERVICES</span></h2>
...
<div class="inner-page-content-row-odd">
	...
	<div class="odd-left wow fadeInLeft" data-wow-delay="0.2s">
        	<img src="<?php echo base_url();?>assets/site/images/services/credit-counseling.jpg" />
        </div>
        <div class="odd-right wow fadeInRight" data-wow-delay="0.4s">
        	<h3 id="Credit">Credit Counseling</h3>
           <!-- <ul>
              ...
              <a style="float: right;" href="<?php echo base_url();?>Credit_Counseling">Explore More <i class="fa fa-arrow-circle-right"></i></a> 
...
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="Loans">Debt Settlement</h3>
            <!--<ul>
            ...
            <a href="<?php echo base_url();?>Debt_Settlement">Explore More <i class="fa fa-arrow-circle-right"></i></a> 
        </div>
        <div class="even-right wow fadeInRight" data-wow-delay="0.4s">
        	<img src="<?php echo base_url();?>assets/site/images/services/debt-management.jpg" />
        </div>
    </div>
</div>
...
<div class="inner-page-content-row-odd">
	<div class="wrapper">
    	<div class="odd-left wow fadeInLeft" data-wow-delay="0.2s">
        	<img src="<?php echo base_url();?>assets/site/images/services/creadit-scr.jpg" />
        </div>
        <div class="odd-right wow fadeInRight" data-wow-delay="0.4s">
        	<h3 id="Medical">Repair Credit  Score</h3>
         <!--   <ul style="width:65%;">
     ...
     <a style="float: right;" href="<?php echo base_url();?>Repair_Score">Explore More <i class="fa fa-arrow-circle-right"></i></a>    
        </div>
    </div>
</div>
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="Mortgages">Rectify Error And Improve Credit Score</h3>
           <!-- <ul>
                ...
                <a href="#">Explore More <i class="fa fa-arrow-circle-right"></i></a>
                 ...
                 <a href="<?php echo base_url();?>Rectify_Error">Explore More <i class="fa fa-arrow-circle-right"></i></a>  
        </div>
       <div class="even-right wow fadeInRight" data-wow-delay="0.4s">
        	<img src="<?php echo base_url();?>assets/site/images/services/Rectify-Error-And-Improve-Credit-Score.jpg" />
        </div>
    </div>
</div>
