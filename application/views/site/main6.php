...
<img src="http://www.cyfrif.com/assets/site/images/optimize.jpg" alt="banner">
    ...
    <div class="banner-caption">
    	<div class="wrapper">
        	<div class="banner-box">
                 <h2>Optimized And<br><span>Accelerate Services</span></h2> 
...
<div class="inner-page-content-row-odd">
	<div class="wrapper">
    	<div class="odd-left wow fadeInLeft" data-wow-delay="0.2s">
        	<img src="<?php echo base_url();?>assets/site/images/services/CRM.jpg" />
        </div>
...
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="Cyfrifpro-Accounting-Software">Cyfrifpro Accounting Software</h3>
            <!--<ul>
        ...
        <div class="even-right wow fadeInRight" data-wow-delay="0.4s">
        	<img src="<?php echo base_url();?>assets/site/images/services/CYFRIFPRO ACCOUNTING SOFTWARE.jpg" />
        </div>
    </div>
</div>
...
<div class="inner-page-content-row-odd">
	<div class="wrapper">
    	<div class="odd-left wow fadeInLeft" data-wow-delay="0.2s">
        	<img src="<?php echo base_url();?>assets/site/images/services/GPRS SERVICE FOR SALES FORCE.jpg" />
        </div>
        <div class="odd-right wow fadeInRight" data-wow-delay="0.4s">
        	<h3 id="GPRS-Service-For-Sales-Force">GPRS Service For Sales Force</h3>
         <!--   <ul style="width:65%;">
...
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="Other-Optimized-Services">Other Optimized Services</h3>
           <!-- <ul>
        ...
        <div class="even-right wow fadeInRight" data-wow-delay="0.4s">
        	<img src="<?php echo base_url();?>assets/site/images/services/OTHER OPTIMIZED SERVICES.jpg" />
        </div>
    </div>
</div>
