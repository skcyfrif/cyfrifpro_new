        ...
        <div class="container">
            <div class="row" style="margin-top: 50px;margin-bottom: 50px;">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus">
                    <h2 class="aboutus-title">FIXED DEPOSIT</h2>
                    <div class="top-head-text">
                        <p>We at Cyfrifpro helping our valued customers to book a fixed deposit at various banks and NBFCs with the highest percentage of return available in market and flexible tenure option in a single window.</p>
