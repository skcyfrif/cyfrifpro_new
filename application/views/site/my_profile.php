        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="email" name= "mail"class="span11" placeholder="Business Email" value="<?php echo $this_element->mail;?>" autocomplete="off" required />
              </div>
            </div> 
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="tel" name= "mobile" maxlength="10"  class="span11" placeholder="Business Mobile" value="<?php echo $this_element->mobile;?>" required />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="person_name"  placeholder="Person Mobile" value="<?php echo $this_element->person_name;?>" autocomplete="off" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Person Mobile :</label>
              <div class="controls">
                <input type="tel" maxlength="10" class="span11" name="person_mobile"  placeholder="Owner Mobile" value="<?php echo $this_element->person_mobile;?>" autocomplete="off" required />
              </div>
              <div class="control-group">
              <label class="control-label">Person Email :</label>
              <div class="controls">
                <input type="email" name= "pmail" class="span11" placeholder="Person Email" value="<?php echo $this_element->pmail;?>" autocomplete="off" required />
              </div>
            </div>
            </div>
            <div class="control-group">
