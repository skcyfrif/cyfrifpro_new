        ...
        <div class="container">
            <div class="row" style="margin-top: 50px;margin-bottom: 50px;">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="aboutus">
                    <h2 class="aboutus-title">DEBT SETTLEMENT</h2>
                    <div class="top-head-text">

<p>We create a healthy environment between creditor and debtor to restructure / settle of unpaid / default debt. Also helps our valued customers to reduce their debt as per predefined personalized plan and make him debt free within the standard horizon. </p>
