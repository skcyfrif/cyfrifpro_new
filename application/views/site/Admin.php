...
class Admin extends CI_Controller 
{
    ...
    public function my_profile() {
        ...
        if ($_POST) {
            ...
            $formData['mail'] = $_POST['mail'];
            $formData['pmail'] = $_POST['pmail'];
    ...
    public function applications($job_id)
    {
        ...
        $data['applications']=$this->Admin_M->get('tbl_career_applications','created','DESC','job_id',$job_id);
    ...
    public function clients($employee_id=NULL)
    {
        ...
        if($employee_id)
        {
            $data['clients']=$this->Admin_M->get('tbl_clients','created','DESC','employee_id',$employee_id);
        }
        else
        {
            $data['clients']=$this->Admin_M->get('tbl_clients','created','DESC');
        }
