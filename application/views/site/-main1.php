    ...
    <div class="banner-caption">
    	<div class="wrapper">
        	<div class="banner-box">
                 <h2>Consultancy<br><span>Services</span></h2>
...
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="GST-Advisory-Services">GST Advisory Services</h3>
            <!--<ul>
...
<div class="inner-page-content-row-odd">
	<div class="wrapper">
        ...
        <div class="odd-right wow fadeInRight" data-wow-delay="0.4s">
         ...
         <ul>
            	<li><i class="fa fa-check-circle"></i> Individuals registered under the Pre-GST law </li>
                <li><i class="fa fa-check-circle"></i> Casual taxable person / Non-Resident taxable person</li>
                <li><i class="fa fa-check-circle"></i> Agents of a supplier & Input service distributor</li>
                <li><i class="fa fa-check-circle"></i>Those paying tax under the reverse charge mechanism</li>
             

                <a href="<?php echo base_url(); ?>gst-Individuals">Explore More <i class="fa fa-arrow-circle-right"></i></a>
            </ul>
        </div>
    </div>
</div>
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="Income-Tax-Advisory-Services">Income Tax Advisory Services</h3>
           <!-- <ul>
...
<div class="inner-page-content-row-even">
	<div class="wrapper">
    	<div class="even-left wow fadeInLeft" data-wow-delay="0.2s">
        	<h3 id="TDS-Advisory-Services">TDS Advisory Services</h3>
          <ul>
            	<li><i class="fa fa-check-circle"></i> Professional fees</li>
                <li><i class="fa fa-check-circle"></i> Fees for technical services</li>
                <li><i class="fa fa-check-circle"></i> Remuneration paid to directors excluding salary</li>
