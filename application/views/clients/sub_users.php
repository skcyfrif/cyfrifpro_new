...
.content {
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
       <a href="<?php echo base_url();?>client/add_subusers/<?php echo $employee_id;?>" ><button class="btn btn-success btn-sm pull-right">+ Add</button></a>
                ...
                $i=1; foreach($clients as $key){ ?>
                    <tr class="gradeX">
                        ...
                        <td class="td-actions">
                            ...
                            <a href="<?php echo base_url();?>client/add_subusers/<?php echo $key->id;?>" class="btn btn-sm btn-info">
                                Edit                                       
                            </a>
                            <?php if($this->Client_M->isLoggedIn() == TRUE){ ?>
