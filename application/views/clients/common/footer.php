        ...
        $("#add_row").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    //alert(b);
                    $('#tab_logic').append('<tr id="addr' + i + '"><td>' + i + '</td><td><select name="title[]" data-id="' + i + '" onchange="getData(this)"><option value="">Select...</option>' + data + '</select></td><td><input type="text" name="unit[]" data-punit="unit' + i + '" id="unit' + i + '" value="" class="form-control" style="width: 80% !important;" readonly> </td><td><input type="number" name="qty[]" placeholder="Qty" class="form-control qty" step="0.01" min="0" id="qty' + i + '" style="width: 80% !important;"/></td><td><input type="number" name="price[]" data-pid="price' + i + '" placeholder="Enter Unit Price" class="form-control price" step="0.01" min="0" id="price' + i + '" readonly/></td><td><input type="text" name="discount[]" data-pid="discount' + i + '" placeholder="discount" class="form-control discount" step="0.01" min="0"/></td><td><input type="text" name="tax[]" data-tax="tax' + i + '" id="tax' + i + '"  placeholder="Enter tax" value="" class="form-control tax" readonly/></td><td><input type="text" name="taxamnt[]" id="taxamnt' + i + '"  data-taxamnt="taxamnt' + i + '" placeholder="Enter tax amount" value="" class="form-control taxamnt" readonly/></td><td><input type="number" name="total[]" placeholder="0.00" id="totalamt' + i + '"   class="form-control total" readonly/></td><td><button type="button" id="delete_row" onclick="deleteRow(this)" data-rowId="addr' + i + '" class="pull-right btn btn-danger">Delete</button></td></tr>');
                    i++;
                    //alert(i);
                    $('#rowCount').val(i);
    ...
    function calc()
    {
        ...
        $('#tab_logic tbody tr').each(function (i, element) {
            ...
            if (html != '') {
                ...
                var discountPrice = ((price*discount)/100)*qty;  //discount;
