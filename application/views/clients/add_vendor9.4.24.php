                    ...
                    <form action="" method="post">
                        <div class="span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span10" name="gst" placeholder="GST" value="<?php echo $this_element->gst; ?>" autocomplete="off" required/>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span10" name="website" placeholder="Website" value="<?php echo $this_element->website; ?>" autocomplete="off" required/>
                                </div>
                            </div>
...
<?php } ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span12" id="fax" name="fax" placeholder="Fax" value="<?php echo $this_element->fax; ?>" required/>
                                                </div>
                                            </div>
                                        </div>
