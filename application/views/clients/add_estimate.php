    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="span6">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span12" name="number" placeholder="Estimate Number" value="<?php echo ($this_element->number) ?? 'EN'.mt_rand(100000, 999999);?>" autocomplete="off" required/>
              </div>
            </div>
            ...
            <div class="control-group" style="margin-top: 25px !important;">
        ...
        <div class="span6">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="date" class="span12" name="expiry_date" value="<?php echo $this_element->expiry_date;?>" autocomplete="off" required/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                 ...
                 <select id="project_name" name="project_name" class="span12" required>
                  <?php if($project){ 
				  
				  		foreach($project as $key){ ?>
                      <option value="<?php echo $key->id;?>" <?php echo ($this_element->project_name==$key->id)?"seloected":"";?> <?php echo $isSelected;?>><?php echo $key->name;?></option>
                  <?php } }  ?>
                      
                </select>
              	
                <!--<input type="text" class="span12" name="project_name" placeholder="Project Name" value="<?php echo $this_element->project_name;?>" required/>-->
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <select id="name" name="sales_person" class="span12" required>
                  <?php if($sales_persons){ foreach($sales_persons as $key){ 
...
function openUrl(val)
{
	...
	if(goUrl == 'goCustomer')
	{
	  	var gUrl='<?php echo base_url().'customer/add_customer?redirect='.$_URL_add_estimate;?>';
...
{
  var gUrl='<?php echo base_url().'inventory/add_inventory?redirect='.$_URL_add_estimate;?>';
