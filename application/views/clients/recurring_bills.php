          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                if($recurring_bills){
                $i=1; foreach($recurring_bills as $kyx => $key){ 
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="td-actions">
                            ...
                            <a href="<?php echo base_url();?>client/add_recurring_bill/<?php echo $key->id;?>" class="btn btn-xs btn-info">
                                Edit                                       
                            </a>

                             <a href="<?php echo base_url();?>client/receipt?for=recurring_bills&id=<?php echo urlencode(base64_encode($key->id));?>" class="btn btn-xs btn-primary">
                                Receipt                                       
                            </a>
                            
                            <a onclick="deleteThis(this)" data-id="<?php echo $key->id; ?>" data-tblName="tbl_recurring_bills" data-returnURL="<?php echo $this->uri->segment(1);?>/<?php echo $this->uri->segment(2); ?>" class="btn btn-xs btn-danger">
                                Delete                                       
                            </a>
                        </td>
                    </tr>
