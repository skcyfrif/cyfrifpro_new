...
<div  class="quick-actions_homepage">
    <ul class="quick-actions">
      <li class="bg_lb"> <a href="<?php echo base_url()?>admin/dashboard"> <i class="icon-dashboard"></i> Dashboard </a> </li>
      ...
      <li class="bg_lo"> <a href="<?php echo base_url();?>admin/users"> <i class="icon-group"></i> Users </a> </li>
