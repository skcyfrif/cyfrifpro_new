          ...
          <div class="widget-content nopadding">
            <table id="table_id" class="table table-bordered data-table">
              ...
              <tbody>
                ...
                if($client_menu){
                $i=1; foreach($client_menu as $key){ ?>
                    <tr class="gradeX">
                        ...
                        <td class="td-actions">
                            ...
                            <a href="<?php echo base_url();?>admin/zone/<?php echo $key->id;?>" class="btn btn-sm btn-primary">
                                Zone                                       
                            </a>

                            <a href="<?php echo base_url();?>admin/client_menu/<?php echo $key->id;?>" class="btn btn-sm btn-info">
                                Edit                                       
                            </a>
                            
                            <a onclick="deleteThis(this)" data-id="<?php echo $key->id; ?>" data-tblName="tbl_client_menu" data-returnURL="<?php echo $this->uri->segment(1);?>/<?php echo $this->uri->segment(2); ?>" class="btn btn-sm btn-danger">
                                Delete                                       
                            </a>
                        </td>
                    </tr>
