       ...
       <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="email" class="span11" placeholder="User" value="<?php echo $this_element->email;?>" autocomplete="off" required disabled />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="email" name= "business_email"class="span11" placeholder="Business Email" value="<?php echo $this_element->business_email;?>" autocomplete="off" required />
              </div>
            </div> 
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="tel" name= "business_mobile" maxlength="10"  class="span11" placeholder="Business Mobile" value="<?php echo $this_element->business_mobile;?>" required />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="person_name"  placeholder="Person Name" value="<?php echo $this_element->person_name;?>" autocomplete="off" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Person Mobile :</label>
              <div class="controls">
                <input type="tel" maxlength="10" class="span11" name="person_mobile"  placeholder="Person Mobile" value="<?php echo $this_element->person_mobile;?>" autocomplete="off" required />
              </div>
              <div class="control-group">
              <label class="control-label">Person Email :</label>
              <div class="controls">
                <input type="email" name= "person_email" class="span11" placeholder="Person Email" value="<?php echo $this_element->person_email;?>" autocomplete="off" required />
              </div>
            </div>
            </div>
            <div class="control-group">
