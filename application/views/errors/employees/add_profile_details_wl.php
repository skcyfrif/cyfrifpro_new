        ...
        <div class="widget-content nopadding">
          ...
          <h4>Personal Details</h4>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="email" class="span11" name="email" placeholder="Email" value="<?php echo $this_element->email;?>" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="passport_number" placeholder="Passport Number" value="<?php echo $this_element->passport_number;?>" />
              </div>
            </div>
      ...
      <table class="table table-bordered table-hover table-sortable" id="tab_logic_education">
            ...
            <td data-name="name">
                <input type="text" name='doneFrom[]'  placeholder='Institute/University' class="form-control" />
						...
						<td data-name="mail">
						    <input type="number" maxlength="4" name='yop[]' placeholder="Year Of Passing" class="form-control" />
						</td>
						<td data-name="desc">
